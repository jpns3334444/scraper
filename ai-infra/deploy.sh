...
EXAMPLES:
    ...
    ./deploy.sh -e dev -b my-sam-bucket --openai-key sk-... --email-from from@example.com --email-to to@example.com

    # Deploy to production
    ./deploy.sh -e prod -s ai-scraper-prod -b my-sam-bucket --openai-key sk-... --email-from from@example.com --email-to to@example.com
...
check_prerequisites() {
    ...
    # Docker is no longer required for ZIP-based Lambda deployment
    # Skip Docker checks
